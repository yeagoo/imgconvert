...
const manifestPath = path.join(extensionDir, "com.ivmm.imgconvert.Codecs.Heic.yml");
...
const metainfoPath = path.join(extensionDir, "com.ivmm.imgconvert.Codecs.Heic.metainfo.xml");
...
function inspectMetainfo(text) {
  for (const expected of [
    "<id>com.ivmm.imgconvert.Codecs.Heic</id>",
    "<extends>com.ivmm.imgconvert</extends>",
